...
/**
 * Support for query execution using {@link Pageable}.
 *
 * @author Mark Paluch
 * @since 1.11
 */
public abstract class PageableExecutionSupport {
	...
	/**
	 * Constructs a {@link Page} based on the given {@code content}, {@link Pageable} and {@link TotalSupplier} applying optimizations.
	 ...
	 * Can be replaced with a Java 8 Supplier when upgrading to Java 8.
	 *
	 * @author Mark Paluch
	 */
